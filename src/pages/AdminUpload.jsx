...
const AdminUpload = () => {
  ...
  const [movieData, setMovieData] = useState({
    ...
    quality: [
      { format: '480p', size: '1.2 GB', type: 'standard', link: '', description: '' },
      { format: '720p', size: '2.8 GB', type: 'standard', link: '', description: '' },
      { format: '1080p', size: '4.5 GB', type: 'standard', link: '', description: '' }
    ]
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Add movie to project data
      const newMovie = addMovie(movieData);
      
      // Show success message
      alert(`Movie "${movieData.title}" uploaded successfully! Movie ID: ${newMovie.id}`);
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <h1 className="text-4xl font-bold text-white mb-2">Admin Upload</h1>
              <p className="text-gray-400">Add new movies to the database</p>
            </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-gray-300 text-sm font-medium mb-2">Initial Views</label>
                    <input
                      type="number"
                      name="views"
            ...
            <div className="mt-8 flex justify-end space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white py-3 px-8 rounded-lg font-semibold transition-all duration-300 flex items-center space-x-2 disabled:opacity-50"
              >
                {isSubmitting ? (
                  <>
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-4 mt-6">
              <p className="text-orange-300 text-sm text-center">
                <strong>Live Mode:</strong> Movies uploaded here will be added to your project and appear immediately on the website.
              </p>
